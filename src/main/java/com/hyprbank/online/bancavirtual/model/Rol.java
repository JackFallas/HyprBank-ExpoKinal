...
import lombok.Data; // Anotacion lombok que genera automaticamente getters, setters, toString(), equals() y hashCode()
import lombok.NoArgsConstructor; // Anotacion lombok que genera constructor sin argumentos (OBLIGATORIO PARA JPA)
import lombok.AllArgsConstructor; // Anotacion lombok que genera un constructor con todos los argumentos
...
public class Rol implements GrantedAuthority {
    ...
    private String nombre; // Ej. "ROLE_USER", "ROLE_ADMIN" (convencion de Spring Security)
