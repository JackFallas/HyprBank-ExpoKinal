 ...
 * 
 * @param <usuario> El tipo de la entidad con la que trabaja este repositorio
 * @param <Long> El tipo de PK de la entidad Usuario (El ID)
 */
@Repository
public interface UsuarioRepository extends JpaRepository<Usuario, Long> {
    /*
     * Este metodo busca a un usuario por su email utilizando este
     * mismo como el "usr" para iniciar sesion
     * 
     ...
     * lo utilizamos para manejar posibles ausencias de usuarios de forma segura evitando NullPointerExeptions
     * 
     */
